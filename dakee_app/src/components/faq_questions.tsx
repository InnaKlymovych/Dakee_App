      ...
      <ul>
        <li>
          ...
          <span onClick={() => handleClick(1)}>
            How does Dakee connect me with locals?
          </span>
        </li>
        {clickedItem === 1 && <p className="outputText">{outputText}</p>}
        <li>
          <img src={list_simble} alt="simble" />
          <span onClick={() => handleClick(2)}>Is Dakee free to use?</span>
        </li>
        {clickedItem === 2 && <p className="outputText">{outputText}</p>}
        <li>
          <img src={list_simble} alt="simble" />
          <span onClick={() => handleClick(3)}>
            Can I book tours or activities through the app with a recommended local?
          </span>
        </li>
